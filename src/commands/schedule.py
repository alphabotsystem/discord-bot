...
PERIOD_TO_TIME = {"5 minutes": 5, "10 minutes": 10, "15 minutes": 15, "20 minutes": 20, "30 minutes": 30, "hour": 60, "2 hours": 120, "3 hours": 180, "4 hours": 240, "6 hours": 360, "8 hours": 480, "12 hours": 720, "1 day": 1440}
		...
		try:
			...
			if totalPostCount == 0:
				...
				for key, post in posts:
					...
					embed = Embed(title=f"Post a {post['command']} every {TIME_TO_PERIOD[post['period']]} starting at {nextPost} UTC.", description=f"Request: `{}`\nChannel: <#{post['channelId']}>\nScheduled by <@{post['authorId']}>", color=constants.colors["deep purple"])
