	...
	async def flow_proxy(self, ctx, tickerId, autodelete):
		try:
			...
			if responseMessage is not None:
				embed = discord.Embed(title=responseMessage, description=get_incorrect_usage_description(self.bot.user.id, "https://www.alpha.bot/pro/flow"), color=constants.colors["gray"])
